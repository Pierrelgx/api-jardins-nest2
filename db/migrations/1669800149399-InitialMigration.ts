...
export class InitialMigration1669800149399 implements MigrationInterface {
    name = 'InitialMigration1669800149399'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "subTotal" integer NOT NULL, "productId" uuid, "orderId" uuid, CONSTRAINT "PK_539ede39e518562dfdadfddb492" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."product_producttype_enum" AS ENUM('legumes', 'fruits', 'oeufs', 'miel', 'divers')`);
        ...
        await queryRunner.query(`CREATE TABLE "cart" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "subTotal" integer NOT NULL, "quantity" integer NOT NULL, "productId" uuid, "userId" uuid, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
